...
class _y3(nn.Module):
    def __init__(self, _y4, _y5, _y6, _y7=50, _y8=0.1):
        ...
        self._ye.append(_x1(_y5, _y5, _y4, _w7=_y8))
        self._ye.append(_x1(_y5, _y5 // 2, _y4, upsample=True, _w7=_y8))
        self._ye.append(_x1(_y5 // 2, _y5 // 2, _y4, _w7=_y8))
        self._yf = nn.ModuleList()
        self._yf.append(_x1(_y5, _y5, _y4, _w7=_y8))
        self._yf.append(_x1(_y5, _y5 // 2, _y4, upsample=True, _w7=_y8))
        self._yf.append(_x1(_y5 // 2, _y5 // 2, _y4, _w7=_y8))
